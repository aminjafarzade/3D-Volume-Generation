...
class StableDiffusion(nn.Module):
    def __init__(self, args, t_range=[0.02, 0.98], unet=None, ae=None):
        super().__init__()
        ...
        self.unet=deepcopy(unet)
        self.unet_lora=deepcopy(unet)
        self.ae=autoencoder
    ...
    def get_vds_loss(
        ...
        pred_eps_wo_lora = self.get_noise_preds(x_t, t + 1, class_label, guidance_scale)
        pred_eps_w_lora = self.get_noise_preds_lora(x_t, t + 1, class_label, guidance_scale)
